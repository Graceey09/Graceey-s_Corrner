...
public class PostController {
    ...
    public ResponseEntity<Post> createPost(@RequestBody CreatePostRequest createPostRequest){
        try{
            ...
            ResponseEntity<Post> response = new ResponseEntity<>(savedPost, HttpStatusCode.valueOf(200));
            return response;
        } catch (Exception e) {
    ...
    public ResponseEntity<Post> findPost(@RequestBody FindPostRequest findPostRequest){
        try{
            ...
            ResponseEntity<Post> response = new ResponseEntity<>(foundPost, HttpStatusCode.valueOf(200));
            return response;
        }
    ...
    public ResponseEntity<Post> deletePost(@RequestBody DeletePostRequest deletePostRequest){
        try{
            ...
            ResponseEntity<Post> response = new ResponseEntity<>(deletedPost, HttpStatusCode.valueOf(200));
            return response;
        }
        catch (Exception exception){
            throw new RuntimeException(exception);
